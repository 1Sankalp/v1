...
import { Settings2, Trash2, X, Pencil, GripHorizontal } from 'lucide-react';
...
const ProjectCard = memo(({ 
  ...
  const handleTitleSave = useCallback((newTitle: string) => {
    ...
    setLocalTitle(title);
    // Create a new project object with the updated title
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <div className="mb-2 title-edit-area" style={{ width: 'calc(100% - 180px)' }}>
        {isEditingTitle ? (
          <input
            type="text"
          ...
          <h3 
            className="text-lg font-bold cursor-text hover:bg-gray-100 rounded-lg transition-colors truncate p-0"
...
export default function DashboardPage() {
  ...
  // Update saveChanges function to show indicator
  const saveChanges = debounce((data: { name?: string; bio?: string; avatar?: string }) => {
    showSavingIndicator();
